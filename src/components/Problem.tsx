    ...
    <Section id="problem">
      ...
      <StaggerGroup className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                <div className="grid h-11 w-11 place-items-center rounded-xl border border-ink-border bg-white text-rose-300/80">
        ...
        >
          ...
          <p className="mt-3 text-sm text-brand-700/80">There's a better way →</p>
        </motion.div>
      </StaggerGroup>
    </Section>
  );
