        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            <motion.button
              ...
              type="button"
              className="group surface relative flex flex-col items-start overflow-hidden p-5 text-left transition-all duration-300 hover:-translate-y-1 hover:border-neutral-300"
            >
              ...
              <div className="relative grid h-12 w-12 place-items-center rounded-xl border border-ink-border bg-white text-brand-600 transition-transform duration-300 group-hover:scale-105">
                <Icon className="h-6 w-6" />
              </div>
              <h3 className="relative mt-4 text-base font-semibold text-neutral-900">{cat.title}</h3>
